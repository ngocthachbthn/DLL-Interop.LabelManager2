namespace LabelManager2
{
    ...
    [ComImport, TypeLibType((short) 0x1000), InterfaceType((short) 2), DefaultMember("_Item"), Guid("3624B9F9-9E5D-11D3-A896-00C04F324E22")]
    public interface SharedCounters
    {
        ...
        extern SharedCounter Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
        [return: MarshalAs(UnmanagedType.Interface)]
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x103)]
        extern SharedCounter Add([In, MarshalAs(UnmanagedType.BStr)] string strName);
        ...
        extern SharedCounter _Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
    }
}
