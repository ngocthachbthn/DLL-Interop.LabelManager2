namespace LabelManager2
{
    ...
    [ComImport, DefaultMember("_Item"), Guid("3624B9EA-9E5D-11D3-A896-00C04F324E22"), TypeLibType((short) 0x1000), InterfaceType((short) 2)]
    public interface DocumentProperties
    {
        ...
        extern DocumentProperty Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
        [return: MarshalAs(UnmanagedType.Interface)]
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0)]
        extern DocumentProperty _Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
    }
}
