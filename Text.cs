namespace LabelManager2
{
    ...
    [ComImport, Guid("3624B9DF-9E5D-11D3-A896-00C04F324E22"), DefaultMember("_Name"), InterfaceType((short) 2), TypeLibType((short) 0x1000)]
    public interface Text
    {
        ...
        [DispId(0x101)]
        IFontDisp Font { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x101)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x101)] set; }
        [DispId(0x102)]
        ...
        [DispId(0x103)]
        int WordWrap { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x103)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x103)] set; }
        [DispId(260)]
        int WordHyphenation { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(260)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(260)] set; }
        [DispId(0x105)]
        int FitToFrame { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x105)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x105)] set; }
        [DispId(0x106)]
        enumAlignment Alignment { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x106)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x106)] set; }
        [DispId(0x107)]
        Variable VariableObject { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x107)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x107)] set; }
        [DispId(0x108)]
        ...
        [DispId(0x109)]
        TextSelection SelText { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x109)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x109)] set; }
        [DispId(0x114)]
        int LineSpacing { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x114)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x114)] set; }
        [DispId(0x115)]
        TextStrings Strings { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x115)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x115)] set; }
        [DispId(0x116)]
        int BackMode { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x116)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x116)] set; }
        [DispId(0x117)]
        enumVerticalAlignment VerticalAlignment { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x117)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x117)] set; }
        [DispId(280)]
        int FixedHeightAutoWidth { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(280)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(280)] set; }
        [DispId(0x119)]
        int MinWidth { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x119)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x119)] set; }
        [DispId(0x11a)]
        int LineCount { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x11a)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x11a)] set; }
        [DispId(0x11b)]
        string LinkedBarcode { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x11b)] get; [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x11b)] set; }
        [DispId(0x57)]
        ...
        extern TextString InsertString([In, MarshalAs(UnmanagedType.BStr)] string strString, [In, MarshalAs(UnmanagedType.Struct)] object Position, [In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x10b)]
        extern void InsertTextObject([In, MarshalAs(UnmanagedType.Interface)] Text TextObject, [In, MarshalAs(UnmanagedType.Struct)] object Position);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x10c)]
        extern void InsertVariable([In, MarshalAs(UnmanagedType.Interface)] Variable Var, [In, MarshalAs(UnmanagedType.Struct)] object Position, [In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x10d)]
        extern void InsertCRLF([In, MarshalAs(UnmanagedType.Struct)] object Position, [In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [return: MarshalAs(UnmanagedType.Interface)]
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(270)]
        extern TextString AppendString([In, MarshalAs(UnmanagedType.BStr)] string strString, [In, MarshalAs(UnmanagedType.Struct)] object Position, [In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x10f)]
        extern void AppendTextObject([In, MarshalAs(UnmanagedType.Interface)] Text TextObject);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x110)]
        extern void AppendVariable([In, MarshalAs(UnmanagedType.Interface)] Variable Var, [In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x111)]
        extern void AppendCRLF([In, MarshalAs(UnmanagedType.Interface)] IFontDisp Font);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x112)]
        extern void Copy();
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x113)]
        extern void Paste([In, MarshalAs(UnmanagedType.Struct)] object Position);
        [return: MarshalAs(UnmanagedType.Interface)]
