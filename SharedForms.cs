namespace LabelManager2
{
    ...
    [ComImport, TypeLibType((short) 0x1000), Guid("3624BA03-9E5D-11D3-A896-00C04F324E22"), InterfaceType((short) 2), DefaultMember("_Item")]
    public interface SharedForms
    {
        [DispId(1)]
        ...
        extern SharedForm Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
        [return: MarshalAs(UnmanagedType.Interface)]
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x103)]
        extern SharedForm Add([In, MarshalAs(UnmanagedType.BStr)] string strName);
        ...
        extern SharedForm _Item([In, MarshalAs(UnmanagedType.Struct)] object Key);
    }
}
